...
describe Creatable::ClassMethods do
  subject { Harness }
  ...
  let(:expected_params) { { block: nil, name: name, type: type, kind_of: [kind_of] } }
  ...
  describe "::attribute" do
    ...
    context "when a block is supplied" do
      it "is expected to yield to the block on creation." do
        expect do |b|
  ...
  describe "::generated_writer_method=" do
    ...
    context "when the value of kind_of is nil" do
      ...
      it "is expected to not raise an error" do
        ...
        expect { new_obj.an_attribute = nil }.not_to raise_error
      end
    end
  end
end
